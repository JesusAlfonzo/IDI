    ...
    <div class="col-md-12">
        <div class="form-group mb-3">
            ...
            <input type="text" name="name" class="form-control @error('name') is-invalid @enderror"
                value="{{ old('name', $product?->name) }}" id="name" placeholder="Nombre">
            @error('name')
        ...
        <div class="form-group mb-3">
            ...
            <input type="text" name="sku" class="form-control @error('sku') is-invalid @enderror"
                value="{{ old('sku', $product?->sku) }}" id="sku" placeholder="SKU">
            @error('sku')
                <span class="invalid-feedback" role="alert">
                    <strong>{{ $message }}</strong>
                </span>
        ...
        <div class="form-group mb-3">
            ...
            <input type="number" name="stock_alert_threshold"
                ...
                value="{{ old('stock_alert_threshold', $product?->stock_alert_threshold) }}" id="stock_alert_threshold"
